...
def rodar_pipeline(cpf_path, mensal_path):
    ...
    df.to_csv(cpf_part1, index=False, chunksize=10000)
    ...
    cpf.to_csv(cpf_part2, index=False, chunksize=10000)
    ...
    improdutivos.to_csv(final_path, index=False, chunksize=10000)
